...
class ArtworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post artworks_url, params: { artwork: { artist_id: @artwork.artist_id, category: @artwork.category, description: @artwork.description, img_path: @artwork.img_path, title: @artwork.title } }
    end
  ...
  test "should update artwork" do
    patch artwork_url(@artwork), params: { artwork: { artist_id: @artwork.artist_id, category: @artwork.category, description: @artwork.description, img_path: @artwork.img_path, title: @artwork.title } }
